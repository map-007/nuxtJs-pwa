<template>
  <div id="AdminLayout" class="w-full">
    <div
      v-if="!userStore.isMobile"
      id="TopNav"
      class="fixed z-30 w-full flex items-center justify-between md:pt-2.5 md:px-2.5"
    >
      <div
        class="flex items-center justify-between lg:shadow-lg md:rounded-full md:shadow-sm px-2 md:pl-6 pl-4 py-[8px] bg-white w-full border-b"
      >
    ...
    >
      ...
      >
        <div class="flex w-full">
          <div v-for="link in linksSecondaryNav" class="w-1/4" :key="link.name">
            <NuxtLink
              :to="link.url"
    ...
    <div
      v-if="!userStore.isMobile"
      id="PreviewButton"
      class="fixed z-30 bottom-10 w-full flex items-center justify-center"
    >
      <button
    ...
    <div
      v-if="userStore.isMobile"
      id="TopNavMobile"
      class="fixed z-30 w-full flex items-center justify-between px-2.5 bg-[#F3F3F1]"
    >
    ...
    >
      <div class="flex w-full">
        <div v-for="link in linksMobile" class="w-1/5" :key="link.name">
          <button
