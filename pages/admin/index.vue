<template>
  <div id="AdminPage" class="flex h-[100vh] pb-4">
    <div
      class="lg:w-[calc(100%-500px)] md:w-[calc(100%-330px)] w-full"
      :class="userStore.isMobile ? 'pt-14' : ''"
    >
      <div class="max-w-[750px] mx-auto pb-24">
        <button
          ...
          :class="userStore.isMobile ? 'mt-8 text-xl' : 'mt-8'"
        >
          <Icon
        ...
        />
        <div v-for="link in userStore.allLinks" class="mt-4" :key="link.id">
          <LinkBox
            v-if="link"
            :link="link"
